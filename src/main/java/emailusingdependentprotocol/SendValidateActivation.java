...
public class SendValidateActivation {
	...
	public static void send(String emailId, String token, String hostName, String scheme) throws Exception{
		...
		/*   message.setContent(
	            ...
	            "<a style=\"color:black;decoration:none;\" href="+scheme+"://"+hostName+":"+port+contextPath+"/ActivationValidated/?userId="+emailId+"&token="+token+">Please click this link to validate your account with edjab...</a>",
	           "text/html");*/
		   	...
		   	message.setContent(   
				   ...
				   "<br>"+
				   "<br>"+
				   "Your account has been registered with us. In order to login, you have to validate your account."+
				   "<br><br>"+
				   "Please click the below link:"+
				   "<br/>"+
				   "<a class=\"label\" href=\""+
				   scheme+"://"+hostName+"/ActivationValidated/?userId="+emailId+"&token="+token+
