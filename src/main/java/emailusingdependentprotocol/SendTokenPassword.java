...
public class SendTokenPassword {

	
	public static void sendEmail(final String emailId, final String token, String hostName,	String scheme) throws Exception{
	    ...
	    Session session = Session.getInstance(props,
		   ...
		   /*message.setContent(
				   ...
				   "<br><h4>Dear User</h4>"+
	            "<a style=\"color:black;decoration:none;\" href="+scheme+"://"+hostName+":"+port+contextPath+"/RenewPassword/ResetPassword/?userId="+emailId+"&token="+token+">Please click this link to renew your password...</a>",
	           "text/html");*/
		   	...
		   	message.setContent(   
				   ...
				   "background: white;"+
				   "font-size: 18px;\">"+
				   "<span style=\"color:blue\">RENEW YOUR PASSWORD</span>"+
				   "</div>"+
				   "<p"+
				   ...
				   "<br>"+
				   "<br>"+
				   "You raised a request to renew your password."+
				   "<br><br>"+
				   "In order to renew, please click the below link:"+
				   "<br/>"+
				   "<a class=\"label\" href=\""+
				   scheme+"://"+hostName+"/RenewPassword/ResetPassword/?userId="+emailId+"&token="+token+
